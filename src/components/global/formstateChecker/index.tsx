...
import { userFormStatus } from "@/actions/user"; // Assuming userFormStatus fetches the form status
import { AnimatedModalDemo } from "@/components/global/popup-form"; // Import the modal component
